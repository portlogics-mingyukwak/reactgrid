...
let component = <ExtTestGrid component={ReactGrid} config={config} />;
ExtTestGrid.displayName = "TestGridPro";
switch (window.location.pathname) {
  case "/enableColumnAndRowSelection":
    component = <ExtTestGrid component={ReactGrid} config={config} enableColumnAndRowSelection />;
    ExtTestGrid.displayName = "TestGridProWithEnableColumnAndRowSelection";
    break;
  case "/enableColumnAndRowSelectionWithSticky":
    component = <ExtTestGrid component={ReactGrid} config={config} enableColumnAndRowSelection enableSticky />;
    ExtTestGrid.displayName = "TestGridProWithStickyAndEnableColumnAndRowSelection";
    break;
  case "/enableSticky":
    component = <ExtTestGrid component={ReactGrid} config={config} enableSticky />;
  ...
  case "/enableFrozenFocus":
    component = <ExtTestGrid component={ReactGrid} config={config} enableFrozenFocus />;
    ExtTestGrid.displayName = "TestGridProWithEnabledFrozenFocus";
    break;
  case "/enablePinnedToBody":
    component = <ExtTestGrid component={ReactGrid} config={enablePinnedToBodyConfig} />;
    ExtTestGrid.displayName = "TestGridProWithEnabledPinnedToBody";
    break;
  case "/enableStickyPinnedToBody":
    component = <ExtTestGrid component={ReactGrid} config={enablePinnedToBodyConfig} enableSticky />;
  ...
  case "/enableAdditionalContent":
    ...
    break;
  case "/enableSymetric":
    component = <ExtTestGrid component={ReactGrid} config={enableSymetric} enableSticky />;
    ExtTestGrid.displayName = "TestGridProWithEnabledSymetric";
    break;
  case "/enableResponsiveStickyTopLeft":
    component = <ExtTestGrid component={ReactGrid} config={enableTopLeftResponsiveSticky} enableSticky />;
    ExtTestGrid.displayName = "TestGridProWithEnabledResponsiveStickyTopLeft";
    break;
  case "/enableResponsiveStickyBottomRight":
    component = <ExtTestGrid component={ReactGrid} config={enableBottomRightResponsiveSticky} enableSticky />;
    ExtTestGrid.displayName = "TestGridWithEnabledResponsiveStickyBottomRight";
    break;
  case "/enableResponsiveStickyPinnedToBodyTopLeft":
    component = <ExtTestGrid component={ReactGrid} config={enableTopLeftResponsiveStickyPinnedToBody} enableSticky />;
    ExtTestGrid.displayName = "TestGridProWithResponsiveStickyPinnedToBody";
    break;
  case "/enableResponsiveStickyPinnedToBodyBottomRight":
    component = (
      <ExtTestGrid component={ReactGrid} config={enableBottomRightResponsiveStickyPinnedToBody} enableSticky />
    );
    ExtTestGrid.displayName = "TestGridProWithResponsiveStickyPinnedToBody";
    break;
  case "/enableSpannedCells":
    component = <ExtTestGrid component={ReactGrid} config={enableSpannedCells} cellType={"header"} />;
    ExtTestGrid.displayName = "TestGridWithSpannedCells";
    break;
  case "/disableVirtualScrolling":
    component = <ExtTestGrid component={ReactGrid} config={disableVirtualScrolling} cellType={"header"} />;
