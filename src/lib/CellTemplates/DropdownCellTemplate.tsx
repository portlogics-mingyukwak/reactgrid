...
export class DropdownCellTemplate implements CellTemplate<DropdownCell> {
  ...
  render(
    ...
    return <DropdownInput onCellChanged={(cell) => onCellChanged(this.getCompatibleCell(cell), true)} cell={cell} />;
  }
}
  ...
  return (
    <div style={{ width: "100%" }} onPointerDown={(e) => onCellChanged({ ...cell, isOpen: true })}>
      <Select
        ...
        onChange={(e) =>
          onCellChanged({ ...cell, selectedValue: (e as OptionType).value, isOpen: false, inputValue: undefined })
        }
